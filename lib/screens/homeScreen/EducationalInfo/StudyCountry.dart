...
class StudyCountry extends StatefulWidget {
  final int value;
...
class _MyAppState extends State<StudyCountry>
    with AutomaticKeepAliveClientMixin<StudyCountry> {
                            ...
                            child: SingleChildScrollView(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    'Top 5 Countries you want to Study in',
                                    style: TextStyle(
